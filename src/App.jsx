  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/login"
          element={!user ? <Login /> : <Navigate to={getHomePath(role)} />}
        />
        <Route
          path="/register"
          element={!user ? <Register /> : <Navigate to={getHomePath(role)} />}
        />
        ...
        >
          ...
          <Route
            path="admin"
            element={role === "admin" ? <DashboardAdmin /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/guru"
            element={role === "admin" ? <ManajemenGuru /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/siswa"
            element={role === "admin" ? <ManajemenSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/kelas"
            element={role === "admin" ? <ManajemenKelas /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/jadwal"
            element={role === "admin" ? <JadwalAdmin /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/nilai"
            element={role === "admin" ? <NilaiAbsensiAdmin /> : <Navigate to="/login" />}
          />
          <Route
            path="admin/pengumuman"
            element={role === "admin" ? <PengumumanAdmin /> : <Navigate to="/login" />}
          />

          {/* GURU */}
          <Route
            path="guru"
            element={role === "guru" ? <DashboardGuru /> : <Navigate to="/login" />}
          />
          <Route
            path="guru/kelas"
            element={role === "guru" ? <KelasSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="guru/nilai"
            element={role === "guru" ? <InputNilai /> : <Navigate to="/login" />}
          />
          <Route
            path="guru/absensi"
            element={role === "guru" ? <Absensi /> : <Navigate to="/login" />}
          />
          <Route
            path="guru/jadwal"
            element={role === "guru" ? <JadwalMengajar /> : <Navigate to="/login" />}
          />
          <Route
            path="guru/pengumuman"
            element={role === "guru" ? <PengumumanGuru /> : <Navigate to="/login" />}
          />

          {/* SISWA */}
          <Route
            path="siswa"
            element={role === "siswa" ? <DashboardSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="siswa/jadwal"
            element={role === "siswa" ? <JadwalSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="siswa/nilai"
            element={role === "siswa" ? <NilaiSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="siswa/absensi"
            element={role === "siswa" ? <AbsensiSiswa /> : <Navigate to="/login" />}
          />
          <Route
            path="siswa/pengumuman"
            element={role === "siswa" ? <PengumumanSiswa /> : <Navigate to="/login" />}
          />
        </Route>
